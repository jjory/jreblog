...
- 敷金(shikikin)・礼金(reikin) は必ず読み取ること。表・条件欄・隅の小さな記載も見落とさない。
  項目名(敷金/礼金/敷/礼/保証金)と数値が表の別セルに離れていても対応付ける:
  * 「1ヶ月」「1.0ヶ月分」「1ヶ月分」→ {"value": 1.0, "unit": "months"}
  * 「0ヶ月」「0ヶ月分」「なし」「無し」「ゼロ」「0」→ {"value": 0, "unit": "months"}
    （重要: 「0ヶ月」は null ではなく必ず value:0, unit:"months" とする）
